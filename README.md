...
- **Tùy chọn Accent Giọng Đọc**: Trang **Cài đặt** (`#/settings`) hiển thị danh sách tất cả các giọng đọc tiếng Anh khả dụng trên thiết bị (ưu tiên các accent US lên đầu). Cho phép bấm phát thử câu chào ngắn để nghe thử và lưu tùy chọn giọng đọc vào lưu trữ trình duyệt để áp dụng đồng bộ cho toàn bộ ứng dụng.
